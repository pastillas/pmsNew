...
<div id="modal1" class="modal modal-fixed-footer">
  <div class="modal-content">
    ...
    <div class="row">
        ...
        <div class="input-field col s12">
          <input type="text" id="supplierBarangay" name="supplierBarangay" required>
          <label for="supplierBarangay">Barangay</label>
        </div>
        <div class="input-field col s12">
          <input type="text" id="supplierContactNumber" name="supplierContactNumber"  required>
          <label for="supplierContactNumber">Contact Number</label>
        </div>
        <div class="input-field col s12">
          <input type="text" id="supplierProprietor" name="supplierProprietor"  required>
          <label for="supplierProprietor">Proprietor</label>
        </div>
        <div class="input-field col s12">
          <input type="text" id="supplierNature" name="supplierNature"  required>
          <label for="supplierNature">Nature of Business</label>
        </div>
