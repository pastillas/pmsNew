	...
	if(!mysqli_query($conn, $sql)){
		...
		if($for_payment == 1 && $delivery_date != null)
			...
			if($for_payment == 2 && $delivery_date != null)
				...
				if($for_payment == 1 && $delivery_date == null && $for_payment_tmp != 1)
					...
					if($for_payment == 2 && $delivery_date == null)
						...
						if($for_payment == 1 && $delivery_date == null && $for_payment_tmp == 1)
							$sql = "UPDATE PR_PO_STATUS SET po_number = $po_number, supplier_pk = $supplier_pk, delivery_date = null, for_payment = $for_payment  WHERE pr_po_status_id = $pr_po_status_id;";
					}
				}
			}
		}
